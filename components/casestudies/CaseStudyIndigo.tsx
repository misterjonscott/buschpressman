    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-6xl mx-auto px-6 py-16 space-y-16">
        ...
        <section className="space-y-8">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
              The existing filter column displayed all possible filters and all possible values, occupying more screen space than necessary, and introducing unnecessary visual clutter.</p>

            <p className="text-muted-foreground leading-relaxed">I replaced lists of checkbox-selected elements with a single input where the user clicks to display a scrolling dropdown of all available options, and can select one or more.  Just as simple as unchecking a checkbox, the user can click the X icon to remove a filter parameter.</p>
        ...
        <section className="space-y-8">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              <h2 className="text-3xl md:text-4xl font-bold">Reusable Filtering</h2>
              <p className="text-muted-foreground leading-relaxed">The existing filter column displayed all possible filters and all possible values, occupying more screen space than necessary, and introducing unnecessary visual clutter.</p>
              <p className="text-muted-foreground leading-relaxed">I replaced lists of checkbox-selected elements with a single input where the user clicks to display a scrolling dropdown of all available options, and can select one or more.  Just as simple as unchecking a checkbox, the user can click the X icon to remove a filter parameter.</p>
              <p className="text-muted-foreground leading-relaxed">By user request, we added the ability to save filtering states, so a complex system of filters can be loaded instantly.  </p>
            </div>
            <motion.div
